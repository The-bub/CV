...
void main() {
	...
	`}var Ta=class extends Et{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Vr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,pc=t(),mc={INK_DEEP:`--ink`,INK_WARM:`--ink-3`,SHADOW:`--field-shadow`,SIGNAL:`--signal`,EMBER:`--ember`};function hc(e){let t=e.replace(`#`,``).trim();t.length===3&&(t=t[0]+t[0]+t[1]+t[1]+t[2]+t[2]);let n=parseInt(t,16);return[(n>>16&255)/255,(n>>8&255)/255,(n&255)/255]}function gc({revealRef:e}){let t=(0,n.useRef)(null);return(0,n.useEffect)(()=>{let n=t.current;if(!n)return;let r;try{r=new uc({canvas:n,antialias:!1,alpha:!1,powerPreference:`high-performance`})}catch{n.style.display=`none`;return}let i=Math.min(window.devicePixelRatio||1,1.5);r.setPixelRatio(i);let a=new fn,o=new ki(-1,1,1,-1,0,1),s={uTime:{value:0},uResolution:{value:new q(1,1)},uMouse:{value:new q(.5,.5)},uMouseForce:{value:0},uReveal:{value:0},uScroll:{value:0},uFlow:{value:0},uReduced:{value:0},INK_DEEP:{value:new J},INK_WARM:{value:new J},SHADOW:{value:new J},SIGNAL:{value:new J},EMBER:{value:new J}},c=document.documentElement,l=()=>{let e=getComputedStyle(c);for(let[t,n]of Object.entries(mc)){let r=e.getPropertyValue(n).trim();r&&s[t].value.fromArray(hc(r))}};l();let u=new MutationObserver(l);u.observe(c,{attributes:!0,attributeFilter:[`data-palette`]});let d=new ti({vertexShader:dc,fragmentShader:fc,uniforms:s,depthTest:!1,depthWrite:!1});d.extensions={derivatives:!0};let f=new kr(new Kr(2,2),d);a.add(f);let p=()=>{let e=window.innerWidth,t=window.innerHeight;r.setSize(e,t,!1),s.uResolution.value.set(e*i,t*i)};p(),window.addEventListener(`resize`,p);let m=new q(.5,.5),h=new q(.5,.5),g=0,_=e=>{let t=e.clientX/window.innerWidth,n=1-e.clientY/window.innerHeight;m.set(t,n),g=1};window.addEventListener(`pointermove`,_,{passive:!0});let v=()=>{let e=document.documentElement.scrollHeight-window.innerHeight;return e>0?Math.min(window.scrollY/e,1):0},y,b=!0,x=performance.now(),S=x,C=0,w=0,T=(e,t,n)=>{let r=Math.min(1,Math.max(0,(n-e)/(t-e)));return r*r*(3-2*r)},E=t=>{if(y=requestAnimationFrame(E),!b)return;let n=Math.min((t-S)/1e3,.05);S=t,s.uTime.value=(t-x)/1e3,h.lerp(m,.08),s.uMouse.value.copy(h),g*=.94,s.uMouseForce.value=g,s.uReveal.value=e?e.current:1,C+=(v()-C)*.1,s.uScroll.value=C,w+=n*.011*(1-T(.02,.12,C)),s.uFlow.value=w,r.render(a,o)};y=requestAnimationFrame(E);let D=()=>{b=!document.hidden};return document.addEventListener(`visibilitychange`,D),()=>{cancelAnimationFrame(y),window.removeEventListener(`resize`,p),window.removeEventListener(`pointermove`,_),document.removeEventListener(`visibilitychange`,D),u.disconnect(),f.geometry.dispose(),d.dispose(),r.dispose()}},[e]),(0,pc.jsx)(`canvas`,{ref:t,className:`field-canvas`,"aria-hidden":`true`})}export{gc as default};